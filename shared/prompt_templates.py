...
def prompt(clinic_info: dict = {}, user_prompt: str = "", max_words: int = 120) -> str:
    ...
    SEQUENCE_STRATEGY = """
        ...
        You are writing a 3-step cold outreach sequence.
        ...
        Each email must feel meaningfully different in angle, structure, and wording.
        Do NOT repeat sentences, framing, or structure across emails.
    """
