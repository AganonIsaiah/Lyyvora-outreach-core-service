...
export default function FilterUI({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        className="cursor-pointer text-sm w-full flex justify-between items-center bg-white border border-gray-200 rounded px-2 py-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
